...
<main class="ml-64 p-8">
    ...
    <header class="flex justify-between items-center mb-8">
        ...
        <button onclick="openAssocModal()" class="flex items-center gap-2 bg-emerald-600 text-white px-6 py-3 rounded-lg hover:bg-emerald-700 transition">
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6">
        <div class="flex flex-wrap gap-4 items-center">
            ...
            <div class="flex-1 min-w-48">
                <select id="filterCours" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500">
            ...
            <!-- Filter by Equipment -->
            <div class="flex-1 min-w-48">
                <select id="filterEquip" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500">
            ...
            <!-- Export Button -->
            <a href="export.php?type=associations" class="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
