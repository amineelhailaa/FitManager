        ...
        <table class="w-full">
            ...
            while ($row = mysqli_fetch_assoc($all)) {
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-gray-600"><?php echo $row['duree'] ?></td>
                    <td class="px-6 py-4 text-gray-600"><?php echo $row['max'] ?></td>
                    <td class="px-6 py-4">
                        <div class="flex justify-center gap-2">
                            <button onclick="openModal('edit', <?php echo $row['id_cours'] ?>)"
                                    class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Modifier">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button onclick="confirmDelete(<?php echo $row['id_cours'] ?>)"
        ...
        <form id="coursForm" action="cours.php" method="POST" class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" id="dur" name="duree_cours" required
                           class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500"
                           placeholder="60">
                </div>
                <div>
...
<div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-xl w-full max-w-md mx-4 p-6">
        <div class="text-center">
            ...
            <p class="text-gray-500 mb-6">Êtes-vous sûr de vouloir supprimer ce cours ? Cette action est
                irréversible.</p>
